...
* src/main/java/pl/coderslab/advanced/abstract
* src/main/java/pl/coderslab/advanced/interfaces
* src/main/java/pl/coderslab/advanced/designpatterns


#### Dzień 2

* src/main/java/pl/coderslab/advanced/functionalinterfaces
* src/main/java/pl/coderslab/advanced/lambda
* src/main/java/pl/coderslab/advanced/stream
* src/main/java/pl/coderslab/advanced/dateapi

    
Poszczególne zadania rozwiązuj w odpowiednich pakietach.
...
```Optional<String> findNameByAddress(String address)```
